...
module full_feature_test_optimization_verify_tb;
  ...
  // Original design
  full_feature_test_optimization_verify_original dut_original(
    .data_in(data_in),
    .addr(addr),
    .control(control),
    .signed(signed),
  ...
  // Mapped design
  full_feature_test_optimization_verify_mapped dut_mapped(
    .data_in(data_in),
    .addr(addr),
    .control(control),
    .signed(signed),
