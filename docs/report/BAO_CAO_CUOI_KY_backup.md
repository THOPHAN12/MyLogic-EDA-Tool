...
2. [Tổng Quan Về EDA và Logic Synthesis](#phần-2-tổng-quan-về-eda-và-logic-synthesis)
3. [Phân Tích và Thiết Kế Hệ Thống](#phần-3-phân-tích-và-thiết-kế-hệ-thống)
4. [Verilog Parser](#phần-4-verilog-parser)
5. [Synthesis Engine - Netlist to AIG Conversion](#phần-5-synthesis-engine---netlist-to-aig-conversion)
6. [Optimization Algorithms](#phần-6-optimization-algorithms)
7. [Technology Mapping](#phần-7-technology-mapping)
8. [Verification](#phần-8-verification)
9. [VLSI CAD Algorithms](#phần-9-vlsi-cad-algorithms)
10. [Simulation](#phần-10-simulation)
11. [CLI Interface](#phần-11-cli-interface)
12. [Implementation Details](#phần-12-implementation-details)
13. [Kết Quả và Đánh Giá](#phần-13-kết-quả-và-đánh-giá)
14. [Kết Luận và Hướng Phát Triển](#phần-14-kết-luận-và-hướng-phát-triển)
15. [Tài Liệu Tham Khảo](#phần-15-tài-liệu-tham-khảo)
...
# PHẦN 2: TỔNG QUAN VỀ EDA VÀ LOGIC SYNTHESIS
...
### 2.1.2. Vai Trò của EDA trong VLSI Design
...
### 2.3.3. Tại Sao Chỉ Dùng AND và NOT?
...
### 2.3.5. Conversion Các Cổng Cơ Bản sang AIG
...
### 2.4.2. So Sánh với MyLogic EDA Tool
...
## 4.2. Tokenization (Lexical Analysis)
...
## 5.3. Gate Conversion Algorithms
...
# PHẦN 6: OPTIMIZATION ALGORITHMS

## 6.1. Tổng Quan Optimization
...
## 6.4. Common Subexpression Elimination (CSE)
...
## 6.5. Constant Propagation (ConstProp)
...
# PHẦN 7: TECHNOLOGY MAPPING

## 7.1. Tổng Quan Technology Mapping
...
# PHẦN 9: VLSI CAD ALGORITHMS

## 9.1. Binary Decision Diagrams (BDD)
...
## 9.2. Boolean Expression Diagrams (BED)
...
## 9.6. Static Timing Analysis (STA)
...
# PHẦN 12: IMPLEMENTATION DETAILS

## 12.1. Programming Language và Tools
...
# PHẦN 14: KẾT LUẬN VÀ HƯỚNG PHÁT TRIỂN
