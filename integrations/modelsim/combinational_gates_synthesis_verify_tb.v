...
module combinational_gates_synthesis_verify_tb;
  ...
  // Original design
  combinational_gates_synthesis_verify_original dut_original(
    .a(a),
    .b(b),
    .c(c),
  ...
  // Mapped design
  combinational_gates_synthesis_verify_mapped dut_mapped(
    .a(a),
    .b(b),
    .c(c),
